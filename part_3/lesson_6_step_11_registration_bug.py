...
class TestRegistrationBug(unittest.TestCase):
    def test_registration_page_1(self):
        ...
        self.assertEqual(welcome_text, "Congratulations! You have successfully registered!", "Successfully message not matched")
